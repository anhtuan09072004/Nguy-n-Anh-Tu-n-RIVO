...
function TayAoPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!ten.trim()) {
      setErrorMsg("Vui lòng nhập tên tay áo!");
      return;
    }

    if (isDuplicateName()) {
      alert("Tên tay áo đã tồn tại!");
      return;
    }
    ...
    const confirmed = window.confirm(
      isEdit
        ? "Bạn có chắc muốn cập nhật tay áo này?"
        : "Bạn có chắc muốn thêm tay áo này?"
    );
    ...
    try {
      ...
      if (isEdit) {
        ...
        alert("Cập nhật tay áo thành công");
      } else {
        await mauSacApi.create({ ten: ten.trim() });
        alert("Thêm tay áo thành công");
      }
