...
function CoAoPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!ten.trim()) {
      setErrorMsg("Vui lòng nhập tên cổ áo!");
      return;
    }

    if (isDuplicateName()) {
      alert("Tên cổ áo đã tồn tại!");
      return;
    }
    ...
    const confirmed = window.confirm(
      isEdit
        ? "Bạn có chắc muốn cập nhật cổ áo này?"
        : "Bạn có chắc muốn thêm cổ áo này?"
    );
    ...
    try {
      ...
      if (isEdit) {
        ...
        alert("Cập nhật cổ áo thành công");
      } else {
